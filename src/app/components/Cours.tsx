...
const coaches = [
  {
    ...
    description:
      "Découvrez notre service libre qui vous offre un accès au gym et à tous ses équipements pendant les plages horaires de boxe libre. Profitez de la liberté de vous entraîner à votre rythme, selon vos envies, avec tout le matériel nécessaire à votre disposition.",
    imageUrl: "cours1.jpg",
  },
  {
    name: "Cedrick Belony",
