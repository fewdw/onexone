...
const courses = [
  ...
  },
  {
    ...
    description:
      "Participez à des séances dynamiques d'une heure adaptée à tous les niveaux. Que vous soyez débutant ou expert, nos cours en groupe vous aideront à atteindre vos objectifs dans une ambiance motivante et conviviale.",
    link: "/abonnement",
  },
  {
    title: "Intro Boxe",
  ...
  return (
    <div className="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="font-bold text-black relative text-center pt-16 pb-16 text-5xl">
          Class Categories
          <div className="absolute left-1/2 transform -translate-x-1/2 w-12 h-0.5 bg-red-500 mt-1"></div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-12">
          {courses.map((course, index) => (
            <div
              key={index}
              className="bg-white rounded-lg overflow-hidden flex flex-col items-center text-center max-w-lg mx-auto lg:max-w-xl"
            >
              ...
              <div className="p-6">
                ...
                <div className="text-left">
                  <a
                    href={course.link}
                    className="inline-block text-red-500 hover:text-red-700 font-semibold uppercase tracking-wide"
                  >
                    En savoir plus
                  </a>
                </div>
