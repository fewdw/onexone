          ...
          <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
            <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
              ...
              <p className="mt-4 text-gray-700">
                ...
                coach sont passionnés et prend le temps d’expliquer les
                exercices et aider tous le monde. Overall 100/10
              </p>
            </blockquote>
            ...
            <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
              ...
              <p className="mt-4 text-gray-700">
                ...
                semaine et des cours privés les fds et je suis très satisfait !
              </p>
            </blockquote>
          </div>
        </div>
